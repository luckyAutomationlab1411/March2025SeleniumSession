...
public class SelectDropDownOptions {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Select selectCountry = new Select(countryEle); List<WebElement> optionsList =
		 * selectCountry.getOptions(); int totalOptions = optionsList.size();
		 * System.out.println("total countries: "+ totalOptions);
		 * 
		 * if(totalOptions == 233) { System.out.println("options count is correct"); }
		 * 
